...
export default function TunggakanAlumni() {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Tunggakan Alumni</h1>
        <p className="text-gray-600 mt-1">Lihat tunggakan santri yang sudah alumni/lulus</p>
      </div>
      ...
      {loading ? (
                  ...
                  <tr key={item.santri_id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <span className="px-2 py-1 text-xs font-medium rounded-full bg-blue-100 text-blue-800">
                        {item.santri.status === 'alumni' || item.santri.status === 'lulus' ? 'Alumni' : item.santri.status}
                      </span>
                    </td>
                    <td className="px-6 py-4 text-sm text-gray-900">
        ...
        <div className="bg-white rounded-lg shadow p-8 text-center">
          ...
          <p className="text-gray-500">Tidak ada tunggakan dari alumni</p>
        </div>
      )}
    </div>
  )
