...
function SantriPreview({ data, onCancel }) {
    ...
    return (_jsxs("div", { children: [_jsx("h2", { className: "text-xl font-semibold mb-4 text-gray-700", children: "Preview Data Santri" }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [_jsxs("div", { className: "space-y-4", children: [_jsxs(Section, { title: "Data Santri", children: [_jsx(Field, { label: "NIS", value: data.nis }), _jsx(Field, { label: "Nama", value: data.nama_santri }), _jsx(Field, { label: "TTL", value: formatTTL(data.tempat_lahir, data.tanggal_lahir) }), _jsx(Field, { label: "Jenis Kelamin", value: data.jenis_kelamin === 'L' ? 'Laki-laki' : 'Perempuan' }), _jsx(Field, { label: "Alamat", value: data.alamat }), _jsx(Field, { label: "Asal Sekolah", value: data.asal_sekolah }), _jsx(Field, { label: "Hobi", value: data.hobi }), _jsx(Field, { label: "Cita-cita", value: data.cita_cita }), _jsx(Field, { label: "Jumlah Saudara", value: data.jumlah_saudara }), _jsx(Field, { label: "Kelas", value: data.kelas }), _jsx(Field, { label: "Asrama", value: data.asrama })] }), _jsxs(Section, { title: "Data Orang Tua", children: [_jsxs("div", { children: [_jsx("h4", { className: "text-sm font-semibold text-gray-600", children: "Data Ayah" }), _jsxs("div", { className: "mt-2 space-y-2", children: [_jsx(Field, { label: "Nama Ayah", value: data.orang_tua?.nama_ayah }), _jsx(Field, { label: "Pekerjaan Ayah", value: data.orang_tua?.pekerjaan_ayah }), _jsx(Field, { label: "HP Ayah", value: data.orang_tua?.hp_ayah })] })] }), _jsxs("div", { children: [_jsx("h4", { className: "text-sm font-semibold text-gray-600", children: "Data Ibu" }), _jsxs("div", { className: "mt-2 space-y-2", children: [_jsx(Field, { label: "Nama Ibu", value: data.orang_tua?.nama_ibu }), _jsx(Field, { label: "Pekerjaan Ibu", value: data.orang_tua?.pekerjaan_ibu }), _jsx(Field, { label: "HP Ibu", value: data.orang_tua?.hp_ibu })] })] })] })] }), _jsx("div", { className: "flex justify-center items-start", children: _jsx("img", { src: fotoSrc, alt: "Foto Santri", className: "w-40 h-48 rounded-lg border object-cover shadow-sm" }) })] }), _jsx("div", { className: "mt-6 flex justify-end", children: _jsx("button", { onClick: onCancel, className: "btn", children: "Tutup" }) })] }));
}
