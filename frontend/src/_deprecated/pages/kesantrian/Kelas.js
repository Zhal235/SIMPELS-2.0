...
export default function KesantrianKelas() {
    ...
    return (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h1", { className: "text-2xl font-semibold text-gray-900", children: "Kelas" }), _jsx("button", { className: "btn btn-primary", onClick: openCreate, children: "+ Tambah Kelas" })] }), _jsx(Card, { children: loading ? (_jsx("div", { className: "p-4 text-gray-600", children: "Memuat data..." })) : items.length === 0 ? (_jsx("div", { className: "p-4 text-gray-600", children: "Belum ada data kelas." })) : (_jsx(Table, { columns: [
                            ...
                            } },
                        {
                            key: 'actions',
                            header: 'Aksi',
                            render: (_v, row) => (_jsxs("div", { className: "flex gap-2", children: [_jsx(Button, { variant: "outline", size: "icon", title: "Edit", className: "border-gray-200 text-gray-700 hover:text-brand hover:border-brand transition-all duration-150 rounded-lg shadow-sm bg-white", onClick: () => openEdit(row), children: _jsx(Edit2, { size: 16 }) }), _jsx(Button, { variant: "outline", size: "icon", title: "Tambah Anggota", className: "border-gray-200 text-gray-700 hover:text-brand hover:border-brand transition-all duration-150 rounded-lg shadow-sm bg-white", onClick: () => openMembers(row), children: _jsx(UserRoundPlus, { size: 16 }) }), _jsx(Button, { variant: "outline", size: "icon", title: "Hapus", className: "border-gray-200 text-gray-700 hover:text-red-500 hover:border-red-300 transition-all duration-150 rounded-lg shadow-sm bg-white", onClick: () => deleteKelas(row), children: _jsx(Trash2, { size: 16 }) })] })),
                        },
