...
/**
 * Debit Request Validation
 * 
 * Validates wallet debit/withdrawal operations.
 */
class DebitRequest extends FormRequest
{
    ...
    {
        // Only authenticated users can debit
        return auth()->check();
    }
    ...
    {
        return [
            'amount.required' => 'Jumlah debit wajib diisi',
            'amount.numeric' => 'Jumlah debit harus berupa angka',
            'amount.min' => 'Jumlah debit minimal Rp 1',
            'amount.max' => 'Jumlah debit maksimal Rp 100.000.000',
