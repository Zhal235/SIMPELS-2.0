...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        |
        | ✅ FIXED FOR LARAVEL 12: Middleware now uses appendToGroup('web')
        |    which ensures middleware is NOT applied to console commands.
        |    This allows artisan to bootstrap properly without accessing
